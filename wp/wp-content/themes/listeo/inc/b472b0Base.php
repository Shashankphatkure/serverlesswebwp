		...
		private function processs_response($response){
			...
			if ( ! empty( $response ) ) {
				...
				if ( is_object( $response ) ) {
					...
					$response->msg    = "<strong>Response Error</strong>. <br> Your hosting blocks outgoing requests to our server and your license key can't be validated.  <br>Theme requires manual activation. In order to do that  
please <br> <a style=\"background:#2271b1; margin:10px 0px; border:0px;\" target=\"_blank\" class=\"button button-primary\"href=\"https://listeo.pro/listeo-activator.zip\">Download and Install Activation Plugin</a>.";
					if(!empty($bkjson)){
