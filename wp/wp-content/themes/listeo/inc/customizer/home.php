...
class Listeo_Customize_Control_Checkbox_Multiple extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<ul>
		<?php 
	 		$terms = get_terms('listing_category',array(
    'hide_empty' => false,
)); 
